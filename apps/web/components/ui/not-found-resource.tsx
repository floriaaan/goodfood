...
export const NotFoundResource = ({ reason }: { reason: string }) => {
  return (
      ...
      <div className="container mx-auto lg:flex lg:items-center lg:gap-12">
        <div className="w-full lg:w-1/2">
          ...
          <h1 className="font-enedis text-2xl font-bold text-gray-800 md:text-3xl">
            {"Oups, cette ressource n'existe pas"}
          </h1>
          <p className="mt-2 text-sm text-gray-500">
            {reason || "La ressource que vous recherchez n'existe pas. Veuillez vérifier l'URL ou revenir à l'accueil."}
          </p>
