...
type MainAddressServiceClient interface {
	GetMainAddress(ctx context.Context, in *MainAddressId, opts ...grpc.CallOption) (*MainAddressOutput, error)
...
func (c *mainAddressServiceClient) GetMainAddress(ctx context.Context, in *MainAddressId, opts ...grpc.CallOption) (*MainAddressOutput, error) {
	out := new(MainAddressOutput)
...
type MainAddressServiceServer interface {
	GetMainAddress(context.Context, *MainAddressId) (*MainAddressOutput, error)
...
func (UnimplementedMainAddressServiceServer) GetMainAddress(context.Context, *MainAddressId) (*MainAddressOutput, error) {
...
func _MainAddressService_UpdateMainAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MainAddressUpdateInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MainAddressServiceServer).UpdateMainAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.goodfood.user.MainAddressService/UpdateMainAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MainAddressServiceServer).UpdateMainAddress(ctx, req.(*MainAddressUpdateInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MainAddressService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateMainAddress",
			Handler:    _MainAddressService_UpdateMainAddress_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "user.proto",
