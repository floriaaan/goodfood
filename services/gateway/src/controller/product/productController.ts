...
export const productController = (app: express.Application) => {
    app.get('/api/product/by-restaurant/:id', (req: Request, res: Response) => {
        const {id} = req.params;
    ...
    app.get('/api/product/type', (req: Request, res: Response) => {
    ...
    app.post('/api/product', (req: Request, res: Response) => {
        const {restaurantId, type, name, image, comment, price, preparation, weight, kilocalories, nutriscore, categories, allergens} = req.body;
    ...
    app.post('/api/product/image', (req: Request, res: Response) => {
