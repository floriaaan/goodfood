...
export const deliveryPersonController = (app: Application) => {
    app.get('/api/delivery-person/:id', (req, res) => {
        const {id} = req.params;
    ...
    app.get('/api/delivery-person', (req, res) => {
    ...
    app.post('/api/delivery-person', (req, res) => {
    ...
    app.put('/api/delivery-person/:id', (req, res) => {
        const {id} = req.params;
        const {firstName, lastName, phone, locationList} = req.body;
    ...
    app.delete('/api/delivery-person/:id', (req, res) => {
        const {id} = req.params;
