...
export const orderController = (app: express.Application) => {
    ...
    app.get('/api/order/by-user/:userId', (req: Request, res: Response) => {
    ...
    app.post('/api/order/by-status', (req: Request, res: Response) => {
    ...
    app.get('/api/order/by-delivery/:deliveryId', (req: Request, res: Response) => {
    ...
    app.get('/api/order/by-payment/:paymentId', (req: Request, res: Response) => {
    ...
    app.delete('/api/order/:orderId', (req: Request, res: Response) => {
        const {orderId} = req.params;
